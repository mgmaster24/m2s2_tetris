...
pub fn lerp(from: &Variant, to: &Variant, weight: &Variant,) -> Variant {
    type CallSig < 'a0, 'a1, 'a2, > = (Variant, RefArg < 'a0, Variant >, RefArg < 'a1, Variant >, RefArg < 'a2, Variant >);
...
pub fn type_convert(variant: &Variant, type_: i64,) -> Variant {
    type CallSig < 'a0, > = (Variant, RefArg < 'a0, Variant >, i64);
...
pub fn var_to_bytes(variable: &Variant,) -> PackedByteArray {
    type CallSig < 'a0, > = (PackedByteArray, RefArg < 'a0, Variant >);
    let args = (RefArg::new(variable),);
    unsafe {
...
pub fn bytes_to_var(bytes: &PackedByteArray,) -> Variant {
    type CallSig < 'a0, > = (Variant, RefArg < 'a0, PackedByteArray >);
...
pub fn instance_from_id(instance_id: i64,) -> Option < Gd < crate::classes::Object > > {
    type CallSig = (Option < Gd < crate::classes::Object > >, i64);
...
pub fn is_same(a: &Variant, b: &Variant,) -> bool {
    type CallSig < 'a0, 'a1, > = (bool, RefArg < 'a0, Variant >, RefArg < 'a1, Variant >);
